...
public class CalServiceServiceLocator extends org.apache.axis.client.Service implements com.aman.services.CalServiceService {
    ...
    private java.lang.String CalService_address = "http://localhost:8089/2CalculatorService/services/CalService";
    ...
    public com.aman.services.CalService getCalService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.aman.services.CalServiceSoapBindingStub _stub = new com.aman.services.CalServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.aman.services.CalService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.aman.services.CalServiceSoapBindingStub _stub = new com.aman.services.CalServiceSoapBindingStub(new java.net.URL(CalService_address), this);
                _stub.setPortName(getCalServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://services.aman.com", "CalServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://services.aman.com", "CalService"));
        }
